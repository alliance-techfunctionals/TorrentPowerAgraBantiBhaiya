...
namespace AT.Print.PDF
{
    public partial class Rpt_HTPDF : DevExpress.XtraReports.UI.XtraReport
    {
        ...
        private void Rpt_HTPDF_BeforePrint(object sender, System.ComponentModel.CancelEventArgs e)
        {
            ...
            #endregion
            #region QRCODE
            if (ConfigurationManager.AppSettings["generateQRCodeinHTBills"].ToString() == "True")
            {
