...
namespace AT.Print
{
    public partial class Rpt_LTMD_TOD_Print_Back : DevExpress.XtraReports.UI.XtraReport
    {
        public Rpt_LTMD_TOD_Print_Back()
        {
            InitializeComponent();
        }

        private void Rpt_LTMD_TOD_Print_Back_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
