...
namespace AT.Print
{
    public partial class Rpt_LTMD_TOD_Print : DevExpress.XtraReports.UI.XtraReport
    {
        public Rpt_LTMD_TOD_Print()
        {
            InitializeComponent();
        }
        ...
        private void Rpt_LTMD_TOD_Print_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            ...
            if (ConfigurationManager.AppSettings["generateQRCodeinSolarLTTODBills"].ToString() == "True")
            {
            ...
            //    bd_powerFactorHindi.TopF = bd_OtherCharges.BottomF;
            //    bd_powerFactor.TopF = bd_OtherCharges.BottomF;
            //    bd_powerFactorValue.TopF = bd_OtherCharges.BottomF;
