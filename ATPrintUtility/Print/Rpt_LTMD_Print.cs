...
namespace AT.Print
{
    public partial class Rpt_LTMD_Print : DevExpress.XtraReports.UI.XtraReport
    {
        public Rpt_LTMD_Print()
        {
            InitializeComponent();
        }
        ...
        private void Rpt_LTMD_Print_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
            var data = sender as Rpt_LTMD_Print;
