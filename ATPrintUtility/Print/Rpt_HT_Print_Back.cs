...
namespace AT.Print
{
    public partial class Rpt_HT_Print_Back : DevExpress.XtraReports.UI.XtraReport
    {
        public Rpt_HT_Print_Back()
        {
            InitializeComponent();
        }

        private void Rpt_HT_Back_BeforePrint(object sender, System.Drawing.Printing.PrintEventArgs e)
        {
